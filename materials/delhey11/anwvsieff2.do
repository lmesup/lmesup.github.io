...
listtex 								/// 
  ...
  using anwvsieff2.txt, replace rstyle(tabdelim) 
...
graph twoway ///
  ...
  saving(anwvsieff2_rankchg, replace)
graph export anwvsieff2_rankchg.eps, replace
...
twoway 									///
  ...
  saving(anwvsieff2_rankparcoord, replace)
graph export anwvsieff2_rankparcoord.eps, replace
restore
...
graph twoway 						 /// 
  ...
  ysize(9) xsize(6) 				///
  saving(anwvsieff2_corrbymean, replace)

graph export "anwvsieff2_corrbymean.eps", replace
...
graph twoway 						///
  ...
  ysize(9) xsize(6) 				///
  saving(anwvsieff2_corrbygini, replace)
graph export "anwvsieff2_corrbygini.eps", replace
...
esttab using "anwvsieff2_regression" ///
...
graph export "anwvsieff2_corrbyaggregates.eps", replace
