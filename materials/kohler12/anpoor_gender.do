...
graph twoway 							///
  ...
  by(cntry, note("") rows(1)) legend(order(1 "Männer" 2 "Frauen"))

graph export anpoor_gender_unemp.eps, replace
...
graph export anpoor_gender_ill.eps, replace
...
graph export anpoor_gender_trennung.eps, replace
...
graph export anpoor_gender_alter.eps, replace
