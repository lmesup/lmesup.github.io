...
graph twoway 							///
  ...
  legend(rows(1) order(1 "Men" 2 "Women" ))

graph export anpoor_gender4_unemp.eps, replace
...
graph export anpoor_gender4_ill.eps, replace
...
graph export anpoor_gender4_trennung.eps, replace
...
graph export anpoor_gender4_alter.eps, replace
