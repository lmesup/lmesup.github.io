...
graph twoway 							///
  ...
  legend(rows(1) order(1 "Niedrig" 2 "Mittel" 3 "Hoch"))

graph export anpoor_edu2_unemp.eps, replace
...
graph export anpoor_edu2_ill.eps, replace
...
graph export anpoor_edu2_trennung.eps, replace
...
graph export anpoor_edu2_alter.eps, replace
