...
graph twoway 							/// 
  ...
  || lowess poor wave if source=="etrennung"  ///
...
graph export anmeasures2_offiziell.eps, replace
...
graph export anmeasures2_unsere.eps, replace
...
graph export anmeasures2_unemp.eps, replace
...
graph export anmeasures2_ill.eps, replace
...
graph export anmeasures2_trennung.eps, replace
...
graph export anmeasures2_age.eps, replace
