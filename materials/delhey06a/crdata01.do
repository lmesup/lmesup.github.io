...
version 8.2
	...
	local mylist "`mylist' lsat men age hinceq edu emp occ mar"  // depvar controls
	local mylist "`mylist' neighbours friends"   // Reference Groups within Country
   ...
   // Labels
	...
	lab var neighbour "LC: Own - Neighbours "
