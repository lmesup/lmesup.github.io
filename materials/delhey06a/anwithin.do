...
version 8
	...
	foreach type in g i {
		foreach diffctry in  poland hungary spain italy france sweden netherlands switzerland {
			replace selected = `diffctry'_`type'
				svyreg lsat selected own contacts  men age age2 lhinceq edu2-edu4 emp2-emp4 occ2-occ6 mar2-mar4  ///
				  if cntry == "Turkey"
	...
	graph export anwithin_i.eps, replace
	...
	graph export anwithin_g.eps, replace
