...
version 8
	...
	lowess lsat switzerland_i, by(country, note("") title("") ) jitter(1) ms(oh) mcolor(black) 
	graph export anlsatex_figure.eps, replace
	...
	forv i = 1/4 {
		regress lsat switzerland_i men age age2 lhinceq edu2-edu4 emp2-emp4 occ2-occ6 mar2-mar4  ///
		  [pweight = pweight] if country == `i'
		estimates store country`i'
	}

	estout country* using anlsatex_table.tex ///
