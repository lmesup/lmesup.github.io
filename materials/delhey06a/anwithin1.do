	// Control for Within Country Comparisons
	// --------------------------------------
...
version 8
	...
	foreach type in g i {
		foreach diffctry in  poland hungary spain italy france sweden netherlands switzerland {
			replace selected = `diffctry'_`type'
				svyreg lsat selected own contacts  men age age2 lhinceq dep edu2-edu4 emp2-emp4 occ2-occ6 mar2-mar4  ///
				  if cntry == "Turkey"
	...
	graph export anwithin1_i.eps, replace
	...
	graph export anwithin1_g.eps, replace
