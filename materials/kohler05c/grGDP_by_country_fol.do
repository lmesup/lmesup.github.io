...
version 8.2
	...
	graph combine most lux, rows(1) imargin(tiny) ysize(2.5) xsize(2.25) iscale(1) graphregion(margin(zero))

	graph export GDP_by_country_fol.eps, replace
