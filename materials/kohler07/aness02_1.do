...
version 9.2
	...
	reg stflife men c_age c_hhmmb c_abspos if touse
	estimates store euA

	reg stflife men c_age c_hhmmb c_abspos c_mabspos if touse
	estimates store container1
	
	reg stflife men c_age c_hhmmb c_relpos if touse
	estimates store container2
	
	reg stflife men c_age c_hhmmb c_mabspos if touse
	estimates store euB

	reg stflife men c_age c_hhmmb c_abspos c_mabspos ia_absmean if touse
	estimates store ia_absmean
	
	reg stflife men c_age c_hhmmb c_relpos c_mabspos ia_relmean if touse
	estimates store ia_relmean
	
	estout euA container1 euB ia_absmean ///
	using aness02_1_stflife.tex ///
	...
	ologit health men c_age c_hhmmb c_abspos if touse
	estimates store euA
	
	ologit health men c_age c_hhmmb c_abspos c_mabspos if touse
	estimates store container1
	
	ologit health men c_age c_hhmmb c_relpos if touse
	estimates store container2
	
	ologit health men c_age c_hhmmb c_mabspos if touse
	estimates store euB
	
	ologit health men c_age c_hhmmb c_abspos c_mabspos ia_absmean if touse
	estimates store ia_absmean
	
	ologit health men c_age c_hhmmb c_relpos c_mabspos ia_relmean if touse
	estimates store ia_relmean
	
	estout euA container1 euB ia_absmean ///
	using aness02_1_health.tex ///
	, replace style(tex) label ///
	  prehead(\begin{tabular}{lrrrr} \hline  2002 & \multicolumn{4}{c}{Model type} \\ ) ///
	  posthead(\hline) ///
	  prefoot(\hline) postfoot(\hline \end{tabular} ) ///
	...
	reg lrscale men c_age c_hhmmb c_abspos if touse
	estimates store euA
	
	reg lrscale men c_age c_hhmmb c_abspos c_mabspos if touse
	estimates store container1
	
	reg lrscale men c_age c_hhmmb c_relpos if touse
	estimates store container2
	
	reg lrscale men c_age c_hhmmb c_mabspos if touse
	estimates store euB
	
	reg lrscale men c_age c_hhmmb c_abspos c_mabspos ia_absmean if touse
	estimates store ia_absmean
	
	reg lrscale men c_age c_hhmmb c_relpos c_mabspos ia_relmean if touse
	estimates store ia_relmean
	
	estout euA container1 euB ia_absmean ///
	using aness02_1_lrscale.tex ///
	, replace style(tex) label ///
	  prehead(\begin{tabular}{lrrrr} \hline  2002 & \multicolumn{4}{c}{Model type} \\ ) ///
	  posthead(\hline) ///
	  prefoot(\hline) postfoot(\hline \end{tabular} ) ///
	...
	logit voter men c_age c_hhmmb c_abspos if touse
	estimates store euA

	logit voter men c_age c_hhmmb c_abspos c_mabspos if touse
	estimates store container1
	
	logit voter men c_age c_hhmmb c_relpos if touse
	estimates store container2
	
	logit voter men c_age c_hhmmb c_mabspos if touse
	estimates store euB
	
	logit voter men c_age c_hhmmb c_abspos c_mabspos ia_absmean if touse
	estimates store ia_absmean
	
	logit voter men c_age c_hhmmb c_relpos c_mabspos ia_relmean if touse
	estimates store ia_relmean
	
	estout euA container1 euB ia_absmean ///
	using aness02_1_voter.tex ///
	, replace style(tex) label ///
	  prehead(\begin{tabular}{lrrrr} \hline  2002 & \multicolumn{4}{c}{Model type} \\ ) ///
	  posthead(\hline) ///
	  prefoot(\hline) postfoot(\hline \end{tabular} ) ///
