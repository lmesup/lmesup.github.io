// Data set  of contact data from ESS 2002 and ESS 2004
...
use $ess/ess1contacts.dta /// Only countries available in both years
  if !inlist(cntry,"EE","FR","IL","SE","SK","UA") , clear
...
// Prepare ESS 
use cntry idno inwmm inwdd inwshh inwsmm using $ess/ess2002 ///
	  if !inlist(cntry,"SI","EE","FR","IL","SE","SK","UA") , clear
...
gen etime = mdyhms(inwmm,inwdd,2002,inwshh,inwsmm,0)
...
// Preperations for Appending ESS 2004
// -----------------------------------
...
use $ess/ess2contacts.dta /// Only countries available in both years
  if !inlist(cntry,"EE","FR","IL","SE","SK","UA") , clear
...
// Prepare ESS
use cntry idno inwmm inwdd inwshh inwsmm using $ess/ess2004 ///
  if !inlist(cntry,"SI","EE","FR","IL","SE","SK","UA") , clear
...
// Preperations for Appending ESS 2002
// -----------------------------------
...
label var result1 "Result of visit (ESS 2002)"
label var result2 "Result of visit (ESS 2004)"
...
compress
label data "Long contact protocolls ESS '02 and '04"
note: Creators: kohler@wzb.eu, fkreuter@survey.umd.edu

save ESScontactbig, replace
