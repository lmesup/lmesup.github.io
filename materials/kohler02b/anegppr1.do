...
* Berufsprestige
* Erstellt Graphik egppre11.gph und egppre2*.gph
version 6.0
clear
set memory 60m
...
graph using temp, l1title(Berufsprestige) saving(egppr11, replace)
...
*/ bor xscale(15,92) xlabel(15,30,45,60,75,90) saving(egppr12a, replace) /*
*/ title("arith. Mittel (Prestige n. Wegener)") fontrb(570) fontcb(290)

hplot treim*, l(egp7) grid s(465) pen(223) ttick/*
*/ bor xscale(20,60) xlabel(20,30,40,50,60) saving(egppr12b, replace) /*
