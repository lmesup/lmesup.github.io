* Traegheit der Parteiidentifikation, lag13
...
* EGP
gen egp = 1 if megp >= 5 & megp <= 7 /* Selbständige */
replace egp = 2 if megp == 1 /* Administrative Dienste */
...
lab val egp megp6
lab def megp6 1 "Selb." 2 "Ad. D." 3 "Experten" 4 "Soz. D." 5 "Mischt." 6 "Arb."
...
* Reproduzierbarkeit 
set seed 731             /* Comment für Zufallsergebnisse */
gen long r = _n          /* Comment für Zufallsergenisse */
* gen long r = uniform() /* Uncomment für Zufallsergebnisse */
gen split = kons==. 
...
svmat des1
save des1_13, replace
restore

* Apply Design 3
* --------------

mlogit pi egp2-egp6 egplag2-egplag6  /*
*/ ikons ispd ib90 ikonslag ispdlag ib90lag  /*
*/ hbil age men olds
fitstat
svymlog pi egp2-egp6 egplag2-egplag6  /*
*/ ikons ispd ib90 ikonslag ispdlag ib90lag  /*
*/ hbil age men olds 
