* Verteilung von EGP im Vergleich mit dem Allbus
* Erstellt Graphik egpfre.gph
...
* VERTEILUNG EGP
ren egpb egpsoep
tab egpsoep welle, col
* mit SOEP Querschnittsgewichten
tab egpsoep welle [iweight=phrf] if egpsoep > 0, col nof
...
* Verteilung im ALLBUS
* Lade egp (Befragter)
use v2 v363 v844 v845 using $allbdir/allb8098, clear
ren v363 egpallb
gen welle=v2-1900
gen weight = v844*v845
tab egpallb welle, col
* mit Gewichtung
tab egpallb welle [iweight=weight] if egpallb > 0, col nof

* Vorbereitung zum Vergleich mit dem SOEP
gen nallb = 1
drop if welle < 84
...
graph using temp, l1title("Anteil (gewichtet)") b2title(Erhebungsjahr)/*
*/  saving(egpfre, replace)
