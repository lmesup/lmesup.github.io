...
*/ l1title("LOG10 (Einkommen)") t2title(" ") saving(egpein1, replace)
...
*/ bor  xscale(900,6000) xlabel(1000,2000,3000,4000,5000,6000) /*
*/ title("arith. Mittel (Einkommen)") saving(egpein2, replace)
exit
