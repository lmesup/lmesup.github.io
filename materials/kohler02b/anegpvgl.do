* Vergleich der Vercodung im Allbus 84-96 mit Mueller/Haun 1994
version 5.0
clear
set memory 60m
...
use v2 v356 v357 v363 using $allbdir/allb8098, clear
* Nach Auswechslung Allbus 1984-1996 eingefügt, um
...
use v2 v376 v377 v383 using $allbdir/allb8098, clear
* Nach Auswechslung Allbus 1984-1996 eingefügt, um
* Ergebnisse zu Reproduzieren
drop if v2 == 1998 
drop v2            
...
use v2 v394 v395 v400 using $allbdir/allb8098, clear
* Nach Auswechslung Allbus 1984-1996 eingefügt, um
* Ergebnisse zu Reproduzieren
drop if v2 == 1998 
drop v2            
...
use v2 v401 v402 v408 using $allbdir/allb8098, clear
* Nach Auswechslung Allbus 1984-1996 eingefügt, um
* Ergebnisse zu Reproduzieren
drop if v2 == 1998 
drop v2            
...
merge bst isc using _allb
dups bst isc, drop
tab _merge
gen control = egp - egpallb if _merge==3
sort bst isc persnr
list bst isc egp egpallb n if control~=0 & control~=. , nol
