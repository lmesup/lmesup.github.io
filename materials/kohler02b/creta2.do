* Eta^2 Einkommen/Prestige -> EGP
* Korrektur von creta.do
...
postfile eta ein p1 p2 k using eta2, replace
...
use v2 v359 v360 v363 v436 v844 v844 /*
...
replace wegen = . if wegen < 20 | wegen > 187
replace treim = . if treim < 14 | treim > 79
gen weight = v844 * v844 if v844<99    /* <- Fehler in eta.do */
