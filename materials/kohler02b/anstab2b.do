* Stationäres Markov-Modell 2. Ordnung 
...
keep if lag3>=2 & lag3<=5

gen n=1

collapse (sum) n=n , by(pid lag1 lag2 lag3)
desmat pid*lag1*lag2*lag3
poisson n _x*, difficult
lrtest, saving(0)
desrep 
desmat pid*lag1*lag2 lag1*lag3 lag2*lag3
poisson n _x*, difficult
lrtest
exit
