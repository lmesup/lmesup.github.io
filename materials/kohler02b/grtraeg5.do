...
lab val egp megp6
lab def megp6 2 "Admin. Dienste" 3 "Experten" 4 "Soz. Dienste" 5 "Mischtypen"  /*
*/ 1 "Selbstaendige" 6 "Arbeiter"
...
hplot stab stab1 if egp1~=egp2, `opt' gaps(0,5,10,15,20,25)  /*
*/glegend(Selbstaendige!Admin. Dienste!Experten!Soz. Dienste!Mischtypen!Arbeiter)/*
*/ s(oi) t2(" ") t1(" ")  /*
