...
version 9
	...
	replace sample = 3 if sample > 3 & sample<.
	// Q
	...
	tw ///
	  || sc Q reach ///
	  if iso3166_2 ~= "MT" & iso3166_2 ~= "TR"   ///
	  , ms(O) mlc(black) mfc(black) ///
	  || lowess Q reach  ///
	  if iso3166_2 ~= "MT" & iso3166_2 ~= "TR"   ///
	  , lc(black) lp(solid)                     ///
...
//	graph export teanQreachmeth.eps, replace

	by sample, sort: pwcorr Q reach if iso3166_2 ~= "MT" & iso3166_2 ~= "TR", sig   ///
