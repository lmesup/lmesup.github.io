* B by male employment - female employment by Survey
* kohler@wz-berlin.de
...
version 9
	...
	// B
	collapse (mean) womenp=women reach (count) N=women [aw=dweight], by(sample survey iso3166_2)
	...
	graph export anBreachmeth.eps, replace

	by sample, sort: pwcorr B reach, sig
