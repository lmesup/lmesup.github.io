...
by ctrname subst (survey): replace substx = substx + .25 if np == 5 & _n==4
...
by ctrname backd (survey): replace backx = backx + .25 if np == 5 & _n==4
...
graph export ansample1.eps, replace
