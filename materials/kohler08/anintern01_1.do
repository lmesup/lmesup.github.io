...
version 9
	...
	twoway ///
	  ...
	  , by(survey, ///
	    title("Figure 3: Proportions of women") ///
	    subtitle("amongst gender heterogenous couples") ///
	    note(Own calculations. Do-File: anintern01_1.do) ///
	    l1title("") iscale(*.8))         ///
	...
	graph export anintern01_1.eps, replace preview(on)


	// Summariy table 
	gen absdif = abs(womenbar-.5) if !quota
	...
	listtex survey absdif tobig index using anintern01_1.tex, rstyle(tabular) replace
