...
using anlr_by_voteing1_sumtab.tex  ///
...
listtex cntryname vstring lrsix* ///
  using anlr_by_voteing1_table.tex  ///
  , replace rstyle(tabular) 	///
...
listtex cntryname vstring lrsixstr*, appendto(anlr_by_voteing1_table.tex)  ///
...
graph export anlr_by_voteing1_EUgraph.eps, replace
...
graph export anlr_by_voteing1_graph.eps, replace
