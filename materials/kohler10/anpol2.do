// anpol2: anpol1 without "Satisfaction with government"
// anpol1: Political Variables without "Politics too complicated" and "trust"
version 9.1
set more off
capture erase anpol2.rtf
capture log close
log using anpol2, replace
...
markout touse voter age men edu egp emp hhinc church discrim ///
   polint govsat democsat lrgroup pi
keep if touse
...
mydummies ctrnum edu emp hhinc egp agegroup polint lrgroup


// Centering
foreach var of varlist democsat {
   sum `var'
...
foreach block in ///
  ...
  local other "polint_2 polint_3 polint_4 "
  local other "`other' pi cdemocsat lrgroup_1 lrgroup_2 lrgroup_4"
