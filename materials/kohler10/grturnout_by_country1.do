...
graph twoway ///
  ...
  note("Note: Percentage of registered electors at most recent national elections"  ///
  "as of 31 December 2007. In USA, voters as a percentage of those eligible"  ///
  "to register. For a note on sources see Appendix A.", span) ///
  ysize(6.5)  ///
  xscale(range(0 108)) 					

graph export grturnout_by_country1_1.eps, replace
!epstopdf grturnout_by_country1_1.eps
