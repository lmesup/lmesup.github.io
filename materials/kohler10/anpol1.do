// anpol1: Political Variables (anpol1) without "Politics too complicated" and "trust"
version 9.1
set more off
capture erase anpol1.rtf
capture log close
log using anpol1, replace
...
// Centering
foreach var of varlist govsat democsat {
   sum `var'
...
foreach block in ///
  ...
  local other "`other' pi cgovsat cdemocsat lrgroup_1 lrgroup_2 lrgroup_4"
