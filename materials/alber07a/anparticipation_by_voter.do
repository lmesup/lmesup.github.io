...
version 9.2
   ...
   // Classify Nations
	...
	graph twoway ///
	  || dot meanb axis, horizontal ms(O) mcolor(black)                 ///
     ...
     note("Source: CSES I, CSES II, ESS '02, ESS '04, EQLS '03 ISSP '04", span)       ///
	  title("Figure 8" "Inequality of alternative forms of participation"))   ///
	  xsize(10) ysize(6.5)  ///
 	  ylabel(`ylab', valuelabel angle(0) labsize(*.8)) ///
	  ytitle("") xtitle(Participation of voters minus participation of non-voters)

	graph export ../figure8.eps, replace preview(on) orientation(landscape)
