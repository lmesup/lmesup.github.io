...
// Get Data
foreach dataset in issp02 cress02_01 cress04_01 {
	use ///
	iso3166_2 petition ///
	...
	foreach k of local K {
		reg petition hhinc2-hhinc5 if iso3166_2 == "`k'" 
		post coefs ("`k'") ("`dataset'") ("hhinc") (_b[hhinc5])
		if "`k'" != "GB" | "`dataset'" != "cress04_01" reg petition edu2 edu3 if iso3166_2 == "`k'" 
		if "`k'" != "GB" | "`dataset'" != "cress04_01" post coefs("`k'") ("`dataset'") ("edu") (_b[edu3])
		reg petition emp1 emp3-emp5 if iso3166_2 == "`k'" 
