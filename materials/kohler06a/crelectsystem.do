// Elections-System-Variables
	...
	gen iso3166_2="DE" if country=="france":country
	...
	// Merge Organisatorial-Degree Data
	// ---------------------------------

	restore
	sort iso3166_2
	merge iso3166_2 using `ess', nokeep
	drop _merge
	sort iso3166_2
	merge iso3166_2 using `evs', nokeep
	drop _merge
	
	sort s_cntry
	save electsystem, replace
	...
	// Bring into order
	egen ctrsort = egroup(voter), label(ctrde)
	sort ctrsort
	listtex ctrsort weekend compet pflicht propor regis nopers orgevs ///
	  using crelectsystem.tex ///
